...
COUNTRY_TO_CC = {
  "United Kingdom":"GB","Great Britain":"GB","UK":"GB","United States":"US","USA":"US",
...
def finished_rows_for_year(y:int):
...
def latest_winner():
    years = [pd.Timestamp.utcnow().year, pd.Timestamp.utcnow().year - 1]
    for y in years:

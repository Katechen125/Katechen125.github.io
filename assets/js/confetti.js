/* Shared themed confetti (logos + colors) for all pages */
(function () {
  const IMG_SRC = {
  ...
  let canvas, ctx, W = 0, H = 0, DPR = Math.max(1, window.devicePixelRatio || 1), rafId = null;

  function ensureCanvas() {
    if (canvas) return;
    canvas = document.createElement('canvas');
    canvas.id = 'kc-confetti';
